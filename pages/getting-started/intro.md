...
1. Satisfy the [prerequisites](prerequisites).
2. Identify the [domain name](domain) you want to use for your SlackerNews instance.
3. Create & install [the Slack app](slack-app) to generate tokens with the right permissions.
4. Install SlackerNews using one of the [supported installation methods](../installation/overview).
